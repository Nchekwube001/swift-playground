...
//  SwiftPlayground
//
//  Created by francis on 29/05/2025.
//

import SwiftUI

struct ResizableHeader<Header:View, StickyHeader:View,Background:View,Content:View>: View {
    ...
    @ViewBuilder private func CombineViewHEader()-> some View{
